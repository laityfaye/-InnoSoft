...
<body>
    ...
    <div style="background-color: #f5f5f5; padding: 15px; border-left: 4px solid #3b82f6; margin: 20px 0;">
        <p style="margin: 0; white-space: pre-wrap;"><?php echo e($replyMessage); ?></p>
    </div>
    
    <?php if($originalMessage): ?>
    <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e5e5;">
        <p style="color: #666; font-size: 14px;"><strong>Votre message original :</strong></p>
        <p style="color: #666; font-size: 14px; white-space: pre-wrap;"><?php echo e($originalMessage); ?></p>
    </div>
    <?php endif; ?>
...
<?php /**PATH C:\Users\laity\Desktop\innosoft\backend\resources\views/emails/contact-reply.blade.php ENDPATH**/ ?>