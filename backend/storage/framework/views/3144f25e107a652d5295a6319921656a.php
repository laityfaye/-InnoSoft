...
<body>
    <div class="container">
        ...
        <div style="text-align: center; margin: 30px 0;">
            <div class="stock-number"><?php echo e($product->stock); ?></div>
            <p style="font-size: 18px; color: #ff6b6b; font-weight: bold; margin: 10px 0;">
                unité<?php echo e($product->stock > 1 ? 's' : ''); ?> restante<?php echo e($product->stock > 1 ? 's' : ''); ?>
        ...
        <div class="section">
            ...
            <div class="info-row">
                ...
                <span class="info-value">#<?php echo e($product->id); ?></span>
            </div>
            <div class="info-row">
                <span class="info-label">Catégorie :</span>
                <span class="info-value"><?php echo e(ucfirst($product->category)); ?></span>
            </div>
            <div class="info-row">
                <span class="info-label">Prix :</span>
                <span class="info-value"><?php echo e(number_format($product->price, 0, ',', ' ')); ?> XOF</span>
            </div>
        </div>
...
<?php /**PATH C:\Users\laity\Desktop\innosoft\backend\resources\views/emails/low-stock-notification.blade.php ENDPATH**/ ?>