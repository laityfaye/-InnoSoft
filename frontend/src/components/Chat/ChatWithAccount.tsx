    ...
    <>
      ...
      {!isOpen && (
        <motion.button
          ...
          className="fixed bottom-24 right-6 w-16 h-16 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center shadow-2xl z-50 hover:shadow-purple-500/50 transition-shadow"
        >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`fixed bottom-6 right-6 w-96 h-[600px] rounded-2xl glass-effect border border-purple-500/20 shadow-2xl z-50 flex flex-col ${
              isMinimized ? 'h-16' : ''
            }`}
            style={{
                    ...
                    <form onSubmit={handleSendMessage} className="p-4 border-t border-purple-500/20">
                      <div className="flex space-x-2">
                        <input
                          ...
                          className="flex-1 px-4 py-2 rounded-lg glass-effect border border-purple-500/20 focus:border-purple-500/50 focus:outline-none text-white [data-theme='light']:text-dark-500 placeholder:text-secondary-400"
                          style={{
